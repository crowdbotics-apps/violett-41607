"""
Django settings for violett_41607 project.
...
ROOT_URLCONF = 'violett_41607.urls'
...
WSGI_APPLICATION = 'violett_41607.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "violett_41607 API",
    "DESCRIPTION": "API documentation for violett_41607 App",
    "VERSION": "v1",
}
